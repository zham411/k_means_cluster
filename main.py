...
def kmeans(
    ...
    """This function runs k-means on the given data
       and  the initial set of centroids.
    ...
    for itr in range(maxiter):
        ...
        if record_heterogeneity is not None:
            # We chose an Ec2 instance as the recording location.
...
# This will need to be changed before the model is re-run.
if False:
...
def ReportGenerator(
    ...
    Function generates easy-erading clustering report. It takes 2 arguments as an input:
        ...
        FillMissingReport - dictionary of rules determining how we are going to fill missing
        values for final report generation (not included in modeling);
    in order to run the function, the following libraries must be imported:
        import pandas as pd
        import numpy as np
    >>> data = pd.DataFrame()
    >>> data['numbers'] = [1, 2, 3]
    ...
    0    # of Prospects        ClusterSize  False    2.000000    1.000000
    1    % of Prospects  ClusterProportion  False    0.666667    0.333333
    ...
    """
    # Fill all missing values with given rules
    ...
    clustersize.Features = "# of Prospects"
    ...
    clusterproportion[
        "Type"
    ] = "% of Prospects"  # rename created cluster df to match report column names
    ...
    )  # concatenate report with clusterT size and nan values
